  ...
  if (serviceError || !service) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[#030d13] px-4 text-center">
        ...
        <Link href="/" className="btn-primary rounded-xl px-6 py-2.5 text-sm font-semibold">
          Back to home
        </Link>
      </div>
    )
    ...
    <div className="min-h-screen bg-[#030d13]">
      <header className="sticky top-0 z-40 border-b border-white/[0.05] bg-[#030d13]/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          <button onClick={() => router.back()} className="text-xs font-semibold text-slate-500 hover:text-white">
            Back
          </button>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-4xl px-4 pb-24 pt-10 sm:px-6">
        <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">Fill in your details and we will send them to the creator.</p>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              >
                {submitting ? 'Placing order...' : 'Confirm and Pay ' + fmt(service.base_price, service.currency)}
              </button>

              <p className="text-center text-[11px] text-slate-600">Secure checkout | Money-back guarantee | No hidden fees</p>
            </form>
          </div>
          ...
          <div className="self-start space-y-4 lg:sticky lg:top-24">
            <div className="overflow-hidden rounded-2xl border border-white/[0.07] bg-[#071e29]/80 p-5">
              ...
              <div className="mb-4 flex items-start gap-3">
                <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl border border-white/[0.06] bg-white/[0.04] text-[11px] text-white">
              ...
              {celeb && (
                <div className="mb-4 flex items-center gap-2 rounded-xl border border-white/[0.05] bg-white/[0.02] p-3">
                  ...
                  {celeb.is_verified && <span className="ml-auto text-[10px] font-bold text-amber">Verified</span>}
                </div>
              )}
